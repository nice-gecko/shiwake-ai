...
| `wholesale_agent_lite` | agent_lite | ¥21,000/月 | agent |
...
const STRIPE_PLANS = {
  ...
  // ===== Agent版 =====
  agent_lite:      { price_id: 'price_xxx', name: 'Agent ライト',   edition: 'agent', limit: 200,   seats: 1, overage_unit_yen: 20 },
...
- [ ] 代理店が wholesale_agent_lite を購入 → 自分の subscription として ¥21,000/月 が請求される
