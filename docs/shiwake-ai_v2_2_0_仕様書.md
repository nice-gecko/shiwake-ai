...
UPDATE users SET plan_key = 'ai_saas_unlimited', edition = 'saas' 
WHERE is_paid = true AND plan_key IS NULL;
```

### 1.3 設計方針の理由

- **plan_key と edition を分けて持つ理由**: edition は機能判定の主軸(SaaS/Agent/Elite)、plan_key は課金ロジック・件数上限の参照に使う。両方持つことで「Agent ライトは agent edition だが含む件数は 200件」という細かい判定が可能。
...
|---|---|---|---|---|---|
| `ai_saas_lite` | saas | ライト | ¥980/月 | 100件 | 旧 lite 相当 |
| `ai_saas_unlimited` | saas | アンリミテッド | ¥5,800/月 | 無制限 | 旧 unlimited 相当 |
| `ai_saas_team_lite` | saas | チームライト | ¥20,000/月 | 5ID | 旧 team_lite 継承 |
| `ai_saas_team_std` | saas | チームスタンダード | ¥50,000/月 | 15ID | 旧 team_std 継承 |
| `ai_saas_team_prem` | saas | チームプレミアム | ¥100,000/月 | 30ID | 旧 team_prem 継承 |

#### Agent版(高価格帯)

| plan_key | edition | 商品名 | 価格 | 含む件数 | 超過単価 |
|---|---|---|---|---|---|
| `agent_lite` | agent | Agent ライト | ¥30,000/月 | 200件 | ¥20/件(v2.2.1で実装) |
...
|---|---|---|---|
| `reseller_ai_saas_lite` | ai_saas_lite | ¥686/月 | saas |
| `reseller_ai_saas_unlimited` | ai_saas_unlimited | ¥4,060/月 | saas |
| `reseller_ai_saas_team_lite` | ai_saas_team_lite | ¥14,000/月 | saas |
| `reseller_ai_saas_team_std` | ai_saas_team_std | ¥35,000/月 | saas |
| `reseller_ai_saas_team_prem` | ai_saas_team_prem | ¥70,000/月 | saas |
| `reseller_agent_lite` | agent_lite | ¥21,000/月 | agent |
| `reseller_agent_std` | agent_std | ¥56,000/月 | agent |
| `reseller_agent_premium` | agent_premium | ¥105,000/月 | agent |
| `reseller_agent_elite` | agent_elite | ¥175,000/月 | elite |
| `reseller_incentive_lite` | incentive_lite | ¥3,500/月 | option |
| `reseller_incentive_std` | incentive_std | ¥7,000/月 | option |
| `reseller_incentive_prem` | incentive_prem | ¥14,000/月 | option |
...
### 2.3 手動作業(2026-05-08 完了)

Claude Code では Stripe ダッシュボードの操作はできないので、以下はユーザー側の手動作業として実施済み。

**Step 1: ✅ 通常プラン9種を作成/流用済み**
- ai_saas_lite (¥980) ✅ 既存
- ai_saas_unlimited (¥5,800) ✅ 既存
- ai_saas_team_lite (¥20,000) ✅ 既存
- ai_saas_team_std (¥50,000) ✅ 既存
- ai_saas_team_prem (¥100,000) ✅ 既存
- agent_lite (¥30,000) ✅ 新規
- agent_std (¥80,000) ✅ 新規
- agent_premium (¥150,000) ✅ 新規
- agent_elite (¥250,000) ✅ 新規

**Step 2: ✅ 代理店プラン12種を新規作成済み**(Bronze 70%価格で登録)
- reseller_ai_saas_lite (¥686) ✅
- reseller_ai_saas_unlimited (¥4,060) ✅
- reseller_ai_saas_team_lite (¥14,000) ✅
- reseller_ai_saas_team_std (¥35,000) ✅
- reseller_ai_saas_team_prem (¥70,000) ✅
- reseller_agent_lite (¥21,000) ✅
- reseller_agent_std (¥56,000) ✅
- reseller_agent_premium (¥105,000) ✅
- reseller_agent_elite (¥175,000) ✅
- reseller_incentive_lite (¥3,500) ✅
- reseller_incentive_std (¥7,000) ✅
- reseller_incentive_prem (¥14,000) ✅

**Step 3: ✅ Coupon 2種類を作成済み**
- `silver_discount`: 名前「代理店ランク Silver 割引」、percent_off=7.14%、Forever
- `gold_discount`: 名前「代理店ランク Gold 割引」、percent_off=14.28%、Forever

**Step 4: ✅ 全 price_ID と coupon ID を仕様書に反映済み**(3.1 STRIPE_PLANS 参照)

**Step 5: ⏸ 旧プラン(lite, unlimited, agency_*)の archive**
全テスト顧客の移行完了後に実施(現時点ではまだ archive しない)。

**Step 6: 既存インセンティブオプション3種は流用**(再作成不要)
incentive_lite (¥5,000) / incentive_std (¥10,000) / incentive_prem (¥20,000)
...
const STRIPE_PLANS = {
  // ===== AI SaaS版 =====
  ai_saas_lite:        { price_id: 'price_1TQjqc2ZetSuudnL00xEQgQs', name: 'ライト',         edition: 'saas',  limit: 100,   seats: 1,  price_yen: 980 },
  ai_saas_unlimited:   { price_id: 'price_1TQlsh2ZetSuudnLlgDUN35b', name: 'アンリミテッド',     edition: 'saas',  limit: null,  seats: 1,  price_yen: 5800 },
  ai_saas_team_lite:   { price_id: 'price_1TUHY92ZetSuudnLZqREfOOb', name: 'チームライト',       edition: 'saas',  limit: null,  seats: 5,  price_yen: 20000 },
  ai_saas_team_std:    { price_id: 'price_1TUHYi2ZetSuudnLaedNUIMq', name: 'チームスタンダード', edition: 'saas',  limit: null,  seats: 15, price_yen: 50000 },
  ai_saas_team_prem:   { price_id: 'price_1TUHZF2ZetSuudnL7g1HzVDM', name: 'チームプレミアム',   edition: 'saas',  limit: null,  seats: 30, price_yen: 100000 },
  // ===== Agent版 =====
  agent_lite:       { price_id: 'price_1TUd472ZetSuudnLROe57E1c', name: 'Agent ライト',         edition: 'agent', limit: 200,   seats: 1, overage_unit_yen: 20, price_yen: 30000 },
  agent_std:        { price_id: 'price_1TUd7k2ZetSuudnLZ1vhQJ4h', name: 'Agent スタンダード',   edition: 'agent', limit: 500,   seats: 1, overage_unit_yen: 20, price_yen: 80000 },
  agent_premium:    { price_id: 'price_1TUd8d2ZetSuudnLrZte7Y7M', name: 'Agent プレミアム',     edition: 'agent', limit: 1500,  seats: 1, overage_unit_yen: 20, price_yen: 150000 },
  // ===== Agent エリート =====
  agent_elite:      { price_id: 'price_1TUd9J2ZetSuudnLGx9mfRDg', name: 'Agent エリート',       edition: 'elite', limit: 3000,  seats: 1, overage_unit_yen: 20, price_yen: 250000 },
  // ===== インセンティブオプション(継続) =====
  incentive_lite:   { price_id: 'price_1TUI5s2ZetSuudnLDdCVo6P2', name: 'インセンティブ ライト',         edition: 'option', price_yen: 5000 },
  incentive_std:    { price_id: 'price_1TUI762ZetSuudnLZPo5BGON', name: 'インセンティブ スタンダード',  edition: 'option', price_yen: 10000 },
  incentive_prem:   { price_id: 'price_1TUI7v2ZetSuudnLYL0b0VjT', name: 'インセンティブ プレミアム',    edition: 'option', price_yen: 20000 },
  // ===== 代理店プラン: AI SaaS版(Bronze 70%基準価格) =====
  reseller_ai_saas_lite:        { price_id: 'price_1TUdQl2ZetSuudnLhCJXQPPN', name: '【代理店】ライト',           edition: 'saas',  limit: 100,   seats: 1,  price_yen: 686,    is_reseller: true, base_plan_key: 'ai_saas_lite' },
  reseller_ai_saas_unlimited:   { price_id: 'price_1TUdRL2ZetSuudnLv2Iv0kU0', name: '【代理店】アンリミテッド',   edition: 'saas',  limit: null,  seats: 1,  price_yen: 4060,   is_reseller: true, base_plan_key: 'ai_saas_unlimited' },
  reseller_ai_saas_team_lite:   { price_id: 'price_1TUdRs2ZetSuudnLBA67cNuu', name: '【代理店】チームライト',     edition: 'saas',  limit: null,  seats: 5,  price_yen: 14000,  is_reseller: true, base_plan_key: 'ai_saas_team_lite' },
  reseller_ai_saas_team_std:    { price_id: 'price_1TUdSp2ZetSuudnL9jEvxnLJ', name: '【代理店】チームスタンダード', edition: 'saas',  limit: null,  seats: 15, price_yen: 35000,  is_reseller: true, base_plan_key: 'ai_saas_team_std' },
  reseller_ai_saas_team_prem:   { price_id: 'price_1TUdTV2ZetSuudnLRXOLd6KP', name: '【代理店】チームプレミアム', edition: 'saas',  limit: null,  seats: 30, price_yen: 70000,  is_reseller: true, base_plan_key: 'ai_saas_team_prem' },
  // ===== 代理店プラン: Agent版 + Elite =====
  reseller_agent_lite:          { price_id: 'price_1TUdTw2ZetSuudnLpgUHWynY', name: '【代理店】Agent ライト',     edition: 'agent', limit: 200,   seats: 1, overage_unit_yen: 20, price_yen: 21000,  is_reseller: true, base_plan_key: 'agent_lite' },
  reseller_agent_std:           { price_id: 'price_1TUdUP2ZetSuudnLAdPhBID2', name: '【代理店】Agent スタンダード', edition: 'agent', limit: 500,   seats: 1, overage_unit_yen: 20, price_yen: 56000,  is_reseller: true, base_plan_key: 'agent_std' },
  reseller_agent_premium:       { price_id: 'price_1TUdUp2ZetSuudnL4AnigsmY', name: '【代理店】Agent プレミアム', edition: 'agent', limit: 1500,  seats: 1, overage_unit_yen: 20, price_yen: 105000, is_reseller: true, base_plan_key: 'agent_premium' },
  reseller_agent_elite:         { price_id: 'price_1TUdVI2ZetSuudnLqLIjPWht', name: '【代理店】Agent エリート',   edition: 'elite', limit: 3000,  seats: 1, overage_unit_yen: 20, price_yen: 175000, is_reseller: true, base_plan_key: 'agent_elite' },
  // ===== 代理店プラン: インセンティブオプション =====
  reseller_incentive_lite:      { price_id: 'price_1TUdhQ2ZetSuudnLX093vJvg', name: '【代理店】インセンティブ ライト',         edition: 'option', price_yen: 3500,  is_reseller: true, base_plan_key: 'incentive_lite' },
  reseller_incentive_std:       { price_id: 'price_1TUdht2ZetSuudnLTUQc9jZp', name: '【代理店】インセンティブ スタンダード',  edition: 'option', price_yen: 7000,  is_reseller: true, base_plan_key: 'incentive_std' },
  reseller_incentive_prem:      { price_id: 'price_1TUdiM2ZetSuudnLBf32E4nl', name: '【代理店】インセンティブ プレミアム',    edition: 'option', price_yen: 14000, is_reseller: true, base_plan_key: 'incentive_prem' },
};
...
**注意**: 段階的アンロック(ルーキー→ジュニア→...)の判定は v2.2.0 では作らない。v2.3.0 以降で `unlock_status` 列を追加して制御する。v2.2.0 では「Agent版ならその機能はON、AI SaaS版ならOFF」のシンプルな判定だけ。
...
現状の料金ページは旧プラン(lite, unlimited, agency_*)が表示されている。これを新プラン(AI SaaS版5プラン + Agent版4プラン)に置き換える。

構成案:

```
┌─ AI SaaS版(自分で操作する仕訳ツール) ────────────┐
│   [ライト ¥980] [アンリミテッド ¥5,800]        │
...
- 旧 agency_* の表示は削除
- インセンティブオプションの表示は AI SaaS版選択時のみ表示
...
| 旧プラン | 新プラン | 備考 |
|---|---|---|
| lite | ai_saas_lite | 価格据え置き |
| unlimited | ai_saas_unlimited | 価格据え置き |
| team_lite | ai_saas_team_lite | 価格据え置き |
| team_std | ai_saas_team_std | 価格据え置き |
| team_prem | ai_saas_team_prem | 価格据え置き |
| agency_light | agent_lite | ¥35,000 → ¥30,000 に値下げ |
...
shiwake-ai は **全9プラン(AI SaaS版5種・Agent版3種・Elite)を代理店に卸売販売**できる。代理店は通常価格の 60〜70% で仕入れ、自分の顧客に再販することで差額をマージンとして得る。
...
| **対象プラン** | 全9プラン(AI SaaS版・Agent版・Elite すべて) |
...
**シミュレーション例**:
- Agent ライト3社: ¥21,000×3 = ¥63,000(Bronze、マージン¥27,000)
- Agent プレミアム3社: ¥105,000×3 = ¥315,000(Silver、マージン¥135,000相当へ昇格)
- Agent エリート 2社+Agent ライト1社: ¥175,000×2+¥21,000 = ¥371,000(Silver)
...
2. ランクが Silver/Gold に上がったら、subscription に Coupon を適用
   - `silver_discount`: 7.14% off → 実質65%価格
   - `gold_discount`: 14.28% off → 実質60%価格
3. ランクが下がったら Coupon を削除 or 別 Coupon に差し替え
4. これにより subscription を解約・再契約することなく価格変更できる

**計算根拠**:
- Bronze→Silver: ¥21,000 → ¥19,500(¥1,500 off / 7.14%)
- Bronze→Gold: ¥21,000 → ¥18,000(¥3,000 off / 14.28%)
...
if (req.method === 'GET' && req.url.startsWith('/api/affiliate/dashboard')) {
  ...
  try {
    ...
    for (const c of customers) {
      const reseller = STRIPE_PLANS[`reseller_${c.plan_key}`];
      if (reseller?.price_yen) monthlyVolume += reseller?.price_yen;
    }
    // 次のランクまで
...
async function updateAllResellerTiers() {
  ...
  for (const r of resellers) {
    ...
    let volume = 0;
    for (const c of customers) {
      const wp = STRIPE_PLANS[`reseller_${c.plan_key}`];
...
│ │顧客 │ プラン         │卸売額  │次回更新 │   │
│ ├──────────────────────────────────────────┤  │
│ │A税理士 │ Agent ライト │¥21,000│2026-06-01│  │
...
Agent ライト   仕入: ¥19,500/月  (定価¥30,000)
...
- [ ] AI SaaS版ユーザーで `/api/user/plan` を叩くと `edition: 'saas'`、`features.auto_ingest: false` が返る
...
- [ ] Stripe テストモードで ai_saas_lite を購入 → users テーブルに plan_key='ai_saas_lite', edition='saas' が入る
- [ ] agent_lite を購入 → plan_key='agent_lite', edition='agent', billing_period_start/end が入る
...
- [ ] 料金ページが新プラン体系で表示される
- [ ] AI SaaS版契約者は SaaS 用サイドバー、Agent版契約者は Agent 用サイドバー
...
- [ ] 月中の累積カウントが正しい
- [ ] ai_saas_lite で 100件超えるとアラート表示(既存ロジック維持)
- [ ] agent_lite で 200件まで含む扱い、201件目はカウントは進むが課金は v2.2.1 まで未対応
...
- [ ] 代理店が reseller_agent_lite を購入 → 自分の subscription として ¥21,000/月 が請求される
