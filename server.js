...
const STRIPE_PLANS = {
  ...
  // ===== Agent版 =====
  agent_lite:                 { price_id: 'price_1TUd472ZetSuudnLROe57E1c', name: 'Agent ライト',                    edition: 'agent', limit: 200,  seats: 1,  price_yen: 30000,  overage_unit_yen: 20 },
  agent_std:                  { price_id: 'price_1TUd7k2ZetSuudnLZ1vhQJ4h', name: 'Agent スタンダード',              edition: 'agent', limit: 500,  seats: 1,  price_yen: 80000,  overage_unit_yen: 20 },
  agent_premium:              { price_id: 'price_1TUd8d2ZetSuudnLrZte7Y7M', name: 'Agent プレミアム',                edition: 'agent', limit: 1500, seats: 1,  price_yen: 150000, overage_unit_yen: 20 },
  // ===== Agent エリート =====
  agent_elite:                { price_id: 'price_1TUd9J2ZetSuudnLGx9mfRDg', name: 'Agent エリート',                  edition: 'elite', limit: 3000, seats: 1,  price_yen: 250000, overage_unit_yen: 20 },
  // ===== インセンティブオプション(継続) =====
  incentive_lite:             { price_id: 'price_1TUI5s2ZetSuudnLDdCVo6P2', name: 'インセンティブ ライト',           edition: 'option', price_yen: 5000,   is_option: true },
  incentive_std:              { price_id: 'price_1TUI762ZetSuudnLZPo5BGON', name: 'インセンティブ スタンダード',     edition: 'option', price_yen: 10000,  is_option: true },
  incentive_prem:             { price_id: 'price_1TUI7v2ZetSuudnLYL0b0VjT', name: 'インセンティブ プレミアム',       edition: 'option', price_yen: 20000,  is_option: true },
  ...
  // ===== 代理店プラン: Agent版 + Elite =====
  reseller_agent_lite:        { price_id: 'price_1TUdTw2ZetSuudnLpgUHWynY', name: '【代理店】Agent ライト',         edition: 'agent', limit: 200,  seats: 1,  price_yen: 21000,  is_reseller: true, base_plan_key: 'agent_lite',    overage_unit_yen: 20 },
  reseller_agent_std:         { price_id: 'price_1TUdUP2ZetSuudnLAdPhBID2', name: '【代理店】Agent スタンダード',   edition: 'agent', limit: 500,  seats: 1,  price_yen: 56000,  is_reseller: true, base_plan_key: 'agent_std',     overage_unit_yen: 20 },
  reseller_agent_premium:     { price_id: 'price_1TUdUp2ZetSuudnL4AnigsmY', name: '【代理店】Agent プレミアム',     edition: 'agent', limit: 1500, seats: 1,  price_yen: 105000, is_reseller: true, base_plan_key: 'agent_premium', overage_unit_yen: 20 },
  reseller_agent_elite:       { price_id: 'price_1TUdVI2ZetSuudnLqLIjPWht', name: '【代理店】Agent エリート',       edition: 'elite', limit: 3000, seats: 1,  price_yen: 175000, is_reseller: true, base_plan_key: 'agent_elite',   overage_unit_yen: 20 },
  // ===== 代理店プラン: インセンティブオプション =====
